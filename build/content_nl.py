...
STRINGS = {
    ...
    "cases_back": "Alle praktijkcases",
    "cases_index": {
        "title": "Praktijkcases — Bedrijf, bruiloft &amp; residentie | DJ Orestis",
        "desc": "Drie praktijkcases in detail: een eindejaarsreceptie in Brussel, een Grieks-Belgische bruiloft, en vier jaar Griekse avonden in een Brussels restaurant.",
        "kicker": "Praktijkcases",
        "h1": "Hoe de avond <span class='gold'>werkelijk verliep</span>",
        "sub": "Drie evenementen in detail — de briefing, de keuzes, en wat er op de dansvloer gebeurde.",
...
""",
    ...
    "fullpackage": {
        ...
        "price": "Vanaf € 1.000 excl. btw", "price_note": "DJ, speakers, microfoons en licht", "price_amount": "1000",
        "facts": [("Vanafprijs", "€ 1.000 excl. btw voor het volledige premiumpakket"),
