...
""",
    ...
    "fullpackage": {
        ...
        "price": "DJ à partir de 600 € HTVA", "price_note": "Production complète sur devis, selon l'événement", "price_amount": "600",
        "facts": [("Prix de départ", "DJ à partir de 600 € HTVA ; production sur devis, selon l'événement"),
...
""",
    ...
    "mykonos": {
        ...
        "facts": [("Prix de départ", "600 € HTVA, hors déplacement et logement"),
